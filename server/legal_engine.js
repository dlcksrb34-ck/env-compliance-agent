...
const TOPIC_PRIORITIES = [
  ...
  {
    topic: '유독물질수입',
    keywords: ['유독물질 수입신고', '유독물질 수입', '유독물질 무신고', '유독물질 신고', '인체등유해성물질', '제한물질 수입허가'],
...
const KREACH_TOPICS = [
  ...
  {
    topic: '신규화학물질_등록신고',
    keywords: ['신규화학물질', '100kg 미만', '100kg 이상', '신규물질 등록', '신규물질 신고', '소량 신규물질', '100kg 미만 신고'],
...
- **신규화학물질**: 100kg 이상은 본등록, 100kg 미만은 신고 의무.
